...
# This variant also force-adds and commits `data/parquet/hyperliquid/`, which
# is ignored by default in `.gitignore`.
10 0 * * * cd $TRADING_LAB && make hl-capture-daily-commit TOP_N=20 >> logs/cron_hl_capture.log 2>&1
