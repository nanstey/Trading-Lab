...
from trading_lab.runner.cross_venue_paper import build_cross_venue_observe_plan
...
def main() -> int:
    p = argparse.ArgumentParser(description="Prepare an observe-only cross-venue paper session.")
