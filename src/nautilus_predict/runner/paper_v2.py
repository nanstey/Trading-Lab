...
class PaperRunnerV2:
    ...
    def run(self) -> PaperRunV2Summary:
        ...
        fill_actor_cfg = ImportableActorConfig(
            actor_path="nautilus_predict.venues.polymarket.paper_fill:PolymarketPaperFillEngine",
            config_path="nautilus_predict.venues.polymarket.paper_fill:PolymarketPaperFillConfig",
            config={
